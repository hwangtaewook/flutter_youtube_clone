...
/// @nodoc
@JsonSerializable()
class _$AppbarMenuImpl implements _AppbarMenu {
  const _$AppbarMenuImpl({required this.title});
...
abstract class _AppbarMenu implements AppbarMenu {
  const factory _AppbarMenu({required final String title}) = _$AppbarMenuImpl;
